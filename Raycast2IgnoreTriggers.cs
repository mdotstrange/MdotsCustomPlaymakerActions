...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Casts a Ray against all Colliders in the scene. Use either a Game Object or Vector3 world position as the origin of the ray. Use GetRaycastInfo to get more detailed info. Option to ignore colliders set to trigger")]
    public class Raycast2IgnoreTriggers : FsmStateAction
    {
